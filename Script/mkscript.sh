...
if [ $i -lt 10 ]
then
    name_dir='/home/zhoulita/scratch/covid_data_unprocessed/covid_19_tweets/corona_tweets_0'$i'_data.txt'
else
    name_dir='/home/zhoulita/scratch/covid_data_unprocessed/covid_19_tweets/corona_tweets_'$i'_data.txt'
fi
cat <<EOF >~/scratch/covid_data_unprocessed/processingScripts/processfile$i.py
import pandas as pd
import ast

with open("/home/zhoulita/scratch/covid_data_unprocessed/covid_19_tweets/places.txt", encoding="utf8") as pls_file:
    pl=[]
...
tws_merge.to_csv("/home/zhoulita/scratch/covid_data_unprocessed/dataFrame/tweet_df_loc_$i.csv")
EOF
